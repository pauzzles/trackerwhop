...
// In Next.js RSC stream, quotes are escaped as \"
...
while ((m = idRegex.exec(html)) !== null) {
  ...
  const pos = m.index;
  // Look forward in the stream chunk for the properties of this campaign
...
console.log("First 15 authentic verified campaigns:");
cleaned.slice(0, 15).forEach((c, idx) => {
